        ...
        <div className="flex flex-col items-center justify-center w-full max-w-lg">
            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-xs my-4">
                  Please wait{" "}
                  <span className="font-extrabold">FixAndPolish</span> Robots
                  are working on you image
                </p>
              </div>
          ...
          >
            ...
            <p className="text-xs mt-4 text-gray-600 mb-4">
              ...
              <span className="underline font-bold">Terms of Service</span>. To
              learn more about how quickbgremove handles your data, check our{" "}
