    ...
    <>
      <div className="bg-white min-h-screen flex items-center justify-center py-10 px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow-md rounded-lg max-w-3xl p-8 border border-gray-200">
          ...
          <p className="text-gray-700 mb-4 leading-relaxed">
            QuickBGRemove provides a service that removes backgrounds from
            images. Our service is offered "as is" without any warranties or
            guarantees regarding the accuracy or quality of the output.
          </p>
          <h2 className="text-xl font-semibold text-indigo-600 mt-6">
            User Responsibilities
          </h2>
          <p className="text-gray-700 mb-4 leading-relaxed">
            By using QuickBGRemove, you agree not to misuse our service. You
            must not attempt to disrupt or interfere with the service, and you
          ...
          <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            violate these terms or engage in any activity that disrupts or
            abuses the service.
          </p>
          <h2 className="text-xl font-semibold text-indigo-600 mt-6">
            Changes to Terms
          ...
          <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            this page, and your continued use of the service indicates
