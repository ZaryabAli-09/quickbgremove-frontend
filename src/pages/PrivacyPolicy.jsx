      ...
      <div className="bg-white min-h-screen flex items-center justify-center py-10 px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow-md rounded-lg max-w-3xl p-8 border border-gray-200">
          ...
          <p className="text-gray-700 mb-4 leading-relaxed">
            At QuickBGRemove, we value your privacy. This Privacy Policy
            outlines the types of personal information that is received and
            collected when you use our website, and how we safeguard your
            information. We do not sell, share, or trade any of your information
            to third parties.
          </p>
          ...
          <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            information is used solely to provide access to our background
            removal service.
          </p>
          <h2 className="text-xl font-semibold text-indigo-600 mt-6">
          ...
          <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            experience and improve our services. We use your email address to
            send occasional updates, newsletters, or important service
            announcements.
          </p>
          <h2 className="text-xl font-semibold text-indigo-600 mt-6">
            Security
          ...
          <p className="text-gray-700 mb-4 leading-relaxed">
            We take your security seriously and use reasonable measures to
